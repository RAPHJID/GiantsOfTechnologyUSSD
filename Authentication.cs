...
public class Authentication
{
        ...
        while (true)
        {
            ...
            switch (choice)
            {
                case 1:
                    ...
                    TheUser
                     authenticatedUser = UserLogin(username, password);
    ...
    public void AddNewUser(TheUser
     user)
    {
     ...
     UserLogin(string username, string password)
    {
     ...
     public void RunAdminDashboard(TheUser
      authenticatedUser, Courses courses)
    {
    ...
    public void RunUserDashboard(TheUser
